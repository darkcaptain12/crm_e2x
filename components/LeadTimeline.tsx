...
export default function LeadTimeline({ leadId, initialNotes }: LeadTimelineProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formDataToSend.append('related_type', 'lead')
      formDataToSend.append('related_id', leadId)
